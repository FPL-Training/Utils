package com.fastprac.utils.lib;
/*************************************************************************
 ...
 *
 *  Version:
 *    - Feb. 13, 2013: change the implementation of open and loop file
 *************************************************************************/
...
public final class StdAudio {
    ...
    {
	try { 
	    openClip(filename).start();
	} catch (UnsupportedAudioFileException ue) {
	    System.out.println(filename + "'s audio format is not supported.");
	} catch (LineUnavailableException le) {
	    System.out.println(filename + "'s line is not available.");
	} catch (IOException e) {
	    System.out.println(filename + " has an io error.");
	}
    }
	...
	//throws UnsupportedAudioFileException, LineUnavailableException, IOException {
	try {
	    openClip(filename).loop(Clip.LOOP_CONTINUOUSLY);
	} catch (UnsupportedAudioFileException ue) {
	    System.out.println(filename + "'s audio format is not supported.");
	} catch (LineUnavailableException le) {
	    System.out.println(filename + "'s line is not available.");
